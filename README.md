...
- **App tour** — first-launch spotlight guide, replayable from Home or Settings
...
Current release: **[Sakto v1.6.3](https://github.com/diobrandedd/sakto-finance/releases/tag/v1.6.3)**

1. On your Android phone, download [`sakto-v1.6.3.apk`](https://github.com/diobrandedd/sakto-finance/releases/download/v1.6.3/sakto-v1.6.3.apk).
2. Open the downloaded file.
3. Allow **Install unknown apps** for your browser or file manager when Android asks.
4. Tap **Install** or **Update**.

If you already have Sakto installed, install v1.6.3 over it. Do not uninstall first — that would delete local data. Creating a backup before any update is still recommended.
